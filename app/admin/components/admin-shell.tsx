...
const adminNavItems = [
  ...
  { id: 'widget-catalog', label: 'Widget Catalog', icon: SlidersHorizontal, href: '/admin/widget-catalog' },
  { id: 'dashboard-presets', label: 'Dashboard Presets', icon: LayoutTemplate, href: '/admin/dashboard-presets' },
  { id: 'feature-controls', label: 'Feature Controls', icon: ToggleLeft, href: '/admin/feature-controls' },
  { id: 'data-quality', label: 'Data Quality', icon: DatabaseZap, href: '/admin/data-quality' },
  { id: 'taxonomy', label: 'Taxonomy', icon: Tags, href: '/admin/taxonomy' },
  { id: 'sharing-governance', label: 'Sharing Governance', icon: Share2, href: '/admin/sharing-governance' },
