...
export default function Navbar() {
  ...
  return (
    <motion.nav
      className="sticky top-0 z-40 flex w-full items-center border-b border-border/50 bg-background/95 lg:bg-background/80 text-foreground backdrop-blur-md isolate"
