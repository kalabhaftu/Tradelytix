  ...
  return (
    ...
    >
      <DocsSection title="Core layers">
        <DocsCardGrid>
          <DocsInfoCard icon={Globe} title="App framework" description="Deltalytix is built on Next.js with an app-router architecture and a server-first product shell." />
