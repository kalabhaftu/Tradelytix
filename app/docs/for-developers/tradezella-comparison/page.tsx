...
export default function TradezellaComparisonDocsPage() {
  return (
    <DocsPage
      ...
      description="This page keeps the comparison high level. It describes where Deltalytix differentiates in workflow emphasis without making unsupported claims about external products."
    >
      <DocsSection title="Current positioning">
        <DocsCardGrid>
          <DocsInfoCard icon={BarChart3} title="Analytics-first review" description="Deltalytix leans heavily into dashboard, widget, calendar, and filter-aware performance review." />
