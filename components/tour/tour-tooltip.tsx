...
export const TourTooltip: React.FC = () => {
  ...
  const totalSteps = steps[activeTour] || 1
      ...
      <div className="absolute inset-0 pointer-events-none z-[9999]">
        ...
        <motion.div
          ...
          className={cn(
            ...
            "backdrop-blur-lg bg-background/80 dark:bg-card/75 border border-border/60 rounded-2xl shadow-xl p-5 overflow-hidden",
            placement === 'center'
