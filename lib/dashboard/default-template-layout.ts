...
export const DEFAULT_TEMPLATE_LAYOUT: TemplateLayoutItem[] = [
  ...
  { i: 'drawdown', type: 'drawdown', size: 'small-long', x: 4, y: 10, w: 4, h: 4 },
  { i: 'recent-trades', type: 'recentTrades', size: 'small', x: 8, y: 10, w: 4, h: 8 },
  { i: 'equity-curve', type: 'equityCurve', size: 'large', x: 0, y: 14, w: 8, h: 4 },
  { i: 'win-rate-by-strategy', type: 'winRateByStrategy', size: 'small-long', x: 0, y: 18, w: 4, h: 4 },
  { i: 'daily-cumulative-pnl', type: 'dailyCumulativePnL', size: 'small-long', x: 4, y: 18, w: 4, h: 4 },
  { i: 'account-balance', type: 'accountBalanceChart', size: 'small-long', x: 8, y: 18, w: 4, h: 4 },
  { i: 'pnl-by-strategy', type: 'pnlByStrategy', size: 'small-long', x: 0, y: 22, w: 4, h: 4 },
  { i: 'day-of-week', type: 'dayOfWeekPerformance', size: 'medium', x: 4, y: 22, w: 4, h: 4 },
  { i: 'pnl-by-instrument', type: 'pnlByInstrument', size: 'small-long', x: 8, y: 22, w: 4, h: 4 },
  { i: 'session-analysis', type: 'sessionAnalysis', size: 'medium', x: 0, y: 26, w: 4, h: 4 },
  { i: 'outcome-dist', type: 'outcomeDistribution', size: 'medium', x: 4, y: 26, w: 4, h: 4 },
  { i: 'trade-duration', type: 'tradeDurationPerformance', size: 'small-long', x: 8, y: 26, w: 4, h: 4 },
  { i: '22c371e9-0750-4416-9348-96152d86230e', type: 'performanceSummary', size: 'large', x: 0, y: 30, w: 12, h: 4 },
]
