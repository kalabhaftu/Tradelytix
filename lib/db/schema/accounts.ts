...
export const Payout = pgTable('payout', {
  ...
  rejectedDate: timestamp('rejected_date', { withTimezone: true, mode: 'date' }),
  notes: text('notes'),
...
export const PhaseAccount = pgTable('phase_account', {
  ...
  timeLimitDays: integer('time_limit_days'),
  consistencyRulePercent: doublePrecision('consistencyRulePercent').default(0),
  profitSplitPercent: doublePrecision('profit_split_percent'),
  payoutCycleDays: integer('payout_cycle_days'),
  minProfitForPayout: doublePrecision('min_profit_for_payout'),
